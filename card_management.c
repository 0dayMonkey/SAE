...
{
    // asigning pairs of matching values to the array
...
void position_cards(WINDOW* card_wins[3][4], int start_y, int start_x,
    int revealed[3][4], int debug)
{
...
void assign_shuffled_values(int card_values[3][4], int values[],
    WINDOW* card_wins[3][4], int start_y, int start_x)
{
...
void refresh_cards(WINDOW* card_wins[3][4], int revealed[3][4],
    int card_values[3][4], int selected[3][4])
{
...
// rerforms a random selection of a card position.
